...
//        FirebaseUser firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        ...
        usersViewModel.usersLiveDataWithId(messageIdUser).observe(this, new Observer<Users>() {
            ...
            public void onChanged(Users users) {
                ...
                if (users.getImageUrl().equals("default")) {
                    ...
                    Glide.with(MessageActivityChat.this).load(users.getImageUrl()).into(usersImage);
                }
        ...
        usersViewModel.readMessageFromFirebase(firebaseUser.getUid(), messageIdUser).observe(this, new Observer<List<Chats>>() {
            ...
            public void onChanged(List<Chats> chats) {
                ...
                messageAdapter = new MessageAdapter(chats, MessageActivityChat.this, imageUrl);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (message.trim().isEmpty()) {
                    Toast.makeText(MessageActivityChat.this, "can send an empty message", Toast.LENGTH_LONG).show();
                    return;
                }

                usersViewModel.sendUserMessageToFirebaseForChat(firebaseUser.getUid(), messageIdUser, message, false);
